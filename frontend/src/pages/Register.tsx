  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#F3F2FA] px-4">
      <div className="w-full max-w-md rounded-2xl bg-white px-10 py-10 shadow-xl">
        ...
        <h1 className="mb-1 text-center text-2xl font-bold text-gray-900">Create Account</h1>
        <p className="mb-7 text-center text-sm text-gray-400">Join Meeami to manage your audio library</p>
